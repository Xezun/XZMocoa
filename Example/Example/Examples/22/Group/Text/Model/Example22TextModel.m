...
- (BOOL)isEqual:(Example22TextModel *)object {
    if ([object isKindOfClass:[Example22TextModel class]]) {
...
+ (Example22TextModel *)contactForIndex:(NSInteger)index {
    ...
    return [Example22TextModel contactWithFirstName:firstName lastName:lastName phone:phone];
}
