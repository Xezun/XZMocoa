...
@interface Example21Contact () 

@end

@implementation Example21Contact
...
- (BOOL)isEqual:(Example21Contact *)object {
    if ([object isKindOfClass:[Example21Contact class]]) {
...
+ (Example21Contact *)contactForIndex:(NSInteger)index {
    ...
    return [Example21Contact contactWithFirstName:firstName lastName:lastName phone:phone];
}
