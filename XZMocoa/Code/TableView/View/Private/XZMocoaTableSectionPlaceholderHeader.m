//
//  XZMocoaTableSectionPlaceholderHeader.m
//  XZMocoa
//
...
#if DEBUG
@implementation XZMocoaTableSectionPlaceholderHeader
...
- (void)viewModelDidChange {
    ...
    self.detailTextLabel.text = [NSString stringWithFormat:@"section: %@, header: %@", sectionName, cellName];
}
@end
#endif
