...
/// @note 试图 AssembleView 表示 UITableView、UICollectionView 抽象合集，表示具有列表特性的一般视图，并非实际视图。
@protocol XZMocoaAssembleModel <XZMocoaModel>
@optional
/// section 的数量。
@property (nonatomic, readonly) NSInteger numberOfSectionModels;
/// section 的数据。
/// - Parameter index: section 的位置
- (nullable id<XZMocoaAssembleViewSectionModel>)modelForSectionAtIndex:(NSInteger)index;
@end
