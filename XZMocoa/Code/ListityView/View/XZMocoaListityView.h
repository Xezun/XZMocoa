...
@interface XZMocoaListityView : UIView <XZMocoaView, XZMocoaListityViewModelDelegate>
...
@property (nonatomic, strong, nullable) __kindof XZMocoaListityViewModel *viewModel;
